...
public class OrderPlacedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5851666132672464084L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderPlacedEvent\",\"namespace\":\"com.ordering.order.event\",\"fields\":[{\"name\":\"orderNumber\",\"type\":\"string\"}]}");
   ...
   */
  public static com.ordering.order.event.OrderPlacedEvent.Builder newBuilder() {
    return new com.ordering.order.event.OrderPlacedEvent.Builder();
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.ordering.order.event.OrderPlacedEvent.Builder newBuilder(com.ordering.order.event.OrderPlacedEvent.Builder other) {
    if (other == null) {
      return new com.ordering.order.event.OrderPlacedEvent.Builder();
    } else {
      return new com.ordering.order.event.OrderPlacedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.ordering.order.event.OrderPlacedEvent.Builder newBuilder(com.ordering.order.event.OrderPlacedEvent other) {
    if (other == null) {
      return new com.ordering.order.event.OrderPlacedEvent.Builder();
    } else {
      return new com.ordering.order.event.OrderPlacedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlacedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ordering.order.event.OrderPlacedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ordering.order.event.OrderPlacedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderNumber)) {
        this.orderNumber = data().deepCopy(fields()[0].schema(), other.orderNumber);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ordering.order.event.OrderPlacedEvent.Builder setOrderNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ordering.order.event.OrderPlacedEvent.Builder clearOrderNumber() {
      orderNumber = null;
